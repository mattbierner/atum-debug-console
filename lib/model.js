...
define(["require", "exports", "knockout-2.2.1", "amulet/record", "atum/compute", "atum/operations/object",
    ...
    (ConsoleViewModel = (function() {
        ...
        self.debug.subscribe((function(debug) {
            return (debug ? self.environments(printEnvironments(debug, run.extract(debug,
                context.environment, null))) : self.environments([]));
        }));
    ...
    (ConsoleViewModel.prototype.selectFrame = (function(frame) {
        this.environments(printEnvironments(this.debug(), frame.environment));
    }));
